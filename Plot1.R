...
## join date and time together and configure it using strptime to be able to use it more freely
...
## call the hist() function to make a histogram with spec. parameters
